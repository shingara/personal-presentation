...
\begin{frame}
  \begin{beamerboxesrounded}{Exercice 14}
    \lstinputlisting[numbers=none,basicstyle=\tiny]{exercices/test_car_14.rb}
  \end{beamerboxesrounded}
\end{frame}
...
\begin{frame}
  \begin{beamerboxesrounded}{YAML}
    \lstinputlisting[numbers=none,basicstyle=\tiny]{sample/yaml.rb}
  \end{beamerboxesrounded}
\end{frame}
...
\begin{frame}
  \begin{beamerboxesrounded}{Ensure}
    \lstinputlisting[numbers=none,basicstyle=\tiny]{sample/ensure.rb}
  \end{beamerboxesrounded}
\end{frame}
...
\begin{frame}
  \begin{beamerboxesrounded}{Utilisation de rubygems}
    \lstinputlisting[numbers=none,basicstyle=\tiny]{sample/rubygems.rb}
  \end{beamerboxesrounded}
\end{frame}
...
\begin{frame}
  \begin{beamerboxesrounded}{Utiliser ruby-debug}
    \lstinputlisting[numbers=none,basicstyle=\tiny]{sample/ruby-debug.rb}
  \end{beamerboxesrounded}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{M\'ethode à la vol\'ee}
    Cela permet de faire des m\'ethodes à la vol\'e \verb?define_method?
  \end{block}
